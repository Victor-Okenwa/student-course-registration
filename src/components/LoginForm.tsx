...
const LoginForm = ({ onSectionChange }: DashboardOverviewProps) => {
    ...
    return (
        <div className="flex justify-center items-center h-screen relative overflow-hidden">
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 z-20 min-w-sm max-w-sm bg-background shadow rounded-lg p-4 border-t-4 border-t-slate-600 border-l-4 border-l-slate-600">
                    <h2 className="text-slate-700 uppercase">Login to your students portal</h2>
                    <FormField
