...
import { BookOpen, Calculator, Clock, TrendingUp, Users, Award, Bell, MessageSquare } from "lucide-react";
...
export function DashboardOverview({ onSectionChange }: DashboardOverviewProps) {
  ...
  const recentCourses = [
    ...
    { code: "CSC 305", title: "Software Engineering", units: 3, status: "Ongoing" },
    { code: "MTH 301", title: "Mathematical Methods", units: 2, status: "Completed" },
    { code: "STA 301", title: "Applied Statistics", units: 3, status: "Ongoing" },
  ];
    ...
    <div className="flex-1 overflow-auto">
      <div className="p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Here's what's happening with your academic progress.</p>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="pt-4 border-t">
                <p className="text-sm text-muted-foreground">Expected Graduation: June 2025</p>
              </div>
            </CardContent>
          </Card>
        </div>
