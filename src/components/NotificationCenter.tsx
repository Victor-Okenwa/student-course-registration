...
export function NotificationCenter() {
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      message:
        "Course registration for 2024/2025 session ends in 3 days. Complete your registration to avoid late fees.",
      type: "warning",
    ...
    },
    {
      ...
      message:
        "Your result for CSC 301 (Database Systems) has been published. Check your academic record for details.",
      type: "success",
      category: "academic",
    ...
    },
    {
      ...
      message:
        "Your school fees payment of ₦150,000 has been confirmed. Receipt available in your account.",
      type: "success",
      category: "payment",
    ...
    },
    {
      ...
      message:
        "The student portal will be undergoing maintenance on January 20th from 2:00 AM to 6:00 AM.",
      type: "info",
      category: "system",
    ...
    },
    {
      ...
      message:
        "You are registered for CSC 401 but missing prerequisite CSC 301. Please contact your advisor.",
      type: "error",
      category: "academic",
    ...
    },
    {
      ...
      message:
        'Your library book "Advanced Database Systems" is due for return in 2 days.',
      type: "warning",
      category: "academic",
  ...
  const categoryStats = {
    ...
    registration: notifications.filter((n) => n.category === "registration")
      .length,
  };
