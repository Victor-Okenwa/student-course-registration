...
import { Search, Filter, BookOpen, Clock, Users, Plus, Minus } from "lucide-react";
...
export function CourseRegistration() {
  ...
  const availableCourses = [
    { code: "CSC 301", title: "Database Systems", units: 3, level: "300", semester: "1st", prerequisites: ["CSC 201"], status: "Available" },
    { code: "CSC 302", title: "Computer Networks", units: 3, level: "300", semester: "1st", prerequisites: ["CSC 202"], status: "Available" },
    { code: "CSC 305", title: "Software Engineering", units: 3, level: "300", semester: "1st", prerequisites: ["CSC 201"], status: "Available" },
    { code: "CSC 307", title: "Artificial Intelligence", units: 3, level: "300", semester: "2nd", prerequisites: ["CSC 205"], status: "Available" },
    { code: "MTH 301", title: "Mathematical Methods", units: 2, level: "300", semester: "1st", prerequisites: ["MTH 201"], status: "Full" },
    { code: "STA 301", title: "Applied Statistics", units: 3, level: "300", semester: "1st", prerequisites: ["MTH 101"], status: "Available" },
    { code: "PHY 301", title: "Quantum Physics", units: 3, level: "300", semester: "2nd", prerequisites: ["PHY 201"], status: "Available" },
    { code: "ENG 301", title: "Technical Writing", units: 2, level: "300", semester: "1st", prerequisites: [], status: "Available" },
  ];

  const registeredCourses = [
    { code: "CSC 301", title: "Database Systems", units: 3, semester: "1st" },
    { code: "CSC 305", title: "Software Engineering", units: 3, semester: "1st" },
  ...
  const totalRegisteredUnits = registeredCourses.reduce((total, course) => total + course.units, 0);
    ...
    <div className="flex-1 overflow-auto">
      <div className="p-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">Register for courses based on your current level and session</p>
        </div>
                ...
                {selectedCourses.length > 0 && (
                  <div className="mt-6 p-4 bg-primary/5 rounded-lg border border-primary/20">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="font-medium">Selected Courses ({selectedCourses.length})</h4>
                      <p className="text-sm text-muted-foreground">Total Units: {totalSelectedUnits}</p>
                    </div>
              ...
              <CardContent>
                ...
                <div className="mt-6 p-4 bg-green-50 rounded-lg border border-green-200">
                  <div className="flex justify-between items-center">
                    <span className="font-medium text-green-800">Total Registered Units</span>
                    <span className="text-lg font-bold text-green-800">{totalRegisteredUnits} / 24</span>
                  </div>
                </div>
              </CardContent>
            </Card>
